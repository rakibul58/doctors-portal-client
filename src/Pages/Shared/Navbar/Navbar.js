...
const Navbar = () => {
...

        {
            !user?.uid ?
                ...
                <>
                    ...
                    <li><button onClick={handleLogOut} className="rounded-xl btn btn-accent text-white lg:ml-2 mt-2 lg:mt-0">Log Out</button></li>
                </>
        }
    </React.Fragment>
    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <label htmlFor="dashboard-layout" tabIndex={2} className="btn btn-ghost lg:hidden ml-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
            </label>
        </div>
    );
